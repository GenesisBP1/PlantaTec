        ...
        <div class="pt-container">
            ...
            <div class="pt-header">
                ...
                <div class="pt-header-actions">
                    <a href="{{ route('plantas.create') }}" class="pt-btn pt-btn-green">+ Registrar planta</a>
                </div>
            </div>
            ...
            <div class="pt-admin-card">
                        ...
                        <tbody>
                            @forelse($plantas as $planta)
                                <tr>
                                    ...
                                    <td>{{ $planta->tipo_zona ?? '—' }}</td>
                                    <td>{{ ucfirst($planta->estado) }}</td>
                                    <td class="pt-table-actions">
                                        <a href="{{ route('plantas.show', $planta) }}" class="pt-action-btn view">Ver</a>
                                        <a href="{{ route('plantas.edit', $planta) }}" class="pt-action-btn edit">Editar</a>
                                        <form action="{{ route('plantas.destroy', $planta) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                ...
                <!-- Paginación -->
                @if($plantas instanceof \Illuminate\Pagination\LengthAwarePaginator && $plantas->hasPages())
