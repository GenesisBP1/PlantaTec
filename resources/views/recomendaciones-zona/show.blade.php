    ...
    <x-slot name="header">
        <div class="pt-header">
            ...
            <div class="pt-header-actions">
                <a href="{{ route('recomendaciones-zona.create') }}" class="pt-btn pt-btn-green">+ Nueva zona</a>
            </div>
        </div>
    </x-slot>
                    ...
                    <table class="pt-admin-table">
                        ...
                        <tbody>
                            @forelse($zonas as $zona)
                                <tr>
                                    <td>{{ $zona->nombre_lugar }}</td>
                                    <td>{{ $zona->tipo_zona ?? '—' }}</td>
                                    <td>{{ Str::limit($zona->descripcion, 60) }}</td>
                                    <td>{{ $zona->latitud }}, {{ $zona->longitud }}</td>
                                    <td class="pt-table-actions">
                                        <a href="{{ route('recomendaciones-zona.show', $zona) }}" class="pt-action-btn view">Ver</a>
                                        <a href="{{ route('recomendaciones-zona.edit', $zona) }}" class="pt-action-btn edit">Editar</a>
                                        <form action="{{ route('recomendaciones-zona.destroy', $zona) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="pt-action-btn delete" onclick="return confirm('¿Eliminar esta zona?')">Eliminar</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="pt-empty center">No hay zonas recomendadas registradas.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
