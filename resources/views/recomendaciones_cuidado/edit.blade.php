                ...
                <form method="POST" action="{{ route('recomendaciones-cuidado.update', $recomendacion->id) }}">
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group full">
                            <label>Planta</label>
                            <input type="text" value="{{ $recomendacion->adopcion->planta->nombre ?? 'Sin planta registrada' }}" disabled>
                        </div>

                        <div class="pt-form-group full">
                            <label>Cuidado</label>
                            <input type="text" value="{{ $recomendacion->plantaCuidado->cuidado->nombre ?? 'Sin cuidado registrado' }}" disabled>
                        </div>

                        <div class="pt-form-group full">
                            <label>Mensaje</label>
                            <textarea name="mensaje" rows="5" required>{{ old('mensaje', $recomendacion->mensaje) }}</textarea>
                        </div>
                        ...
                        <div class="pt-form-group">
                            ...
                            <select name="estado" required>
                                <option value="pendiente" {{ old('estado', $recomendacion->estado) == 'pendiente' ? 'selected' : '' }}>Pendiente</option>
                                <option value="revisada" {{ old('estado', $recomendacion->estado) == 'revisada' ? 'selected' : '' }}>Revisada</option>
                                <option value="atendida" {{ old('estado', $recomendacion->estado) == 'atendida' ? 'selected' : '' }}>Atendida</option>
                            </select>
                        </div>
                    ...
                    <div class="pt-form-actions">
                        <button type="submit" class="pt-btn pt-btn-yellow">Guardar cambios</button>
                        <a href="{{ route('recomendaciones-cuidado.index') }}" class="pt-btn pt-btn-dark">Cancelar</a>
                    </div>
