    ...
    <x-slot name="header">
        <div class="pt-header">
            ...
            <div class="pt-header-actions">
                <a href="{{ route('cuidados.create') }}" class="pt-btn pt-btn-green">
                    Registrar cuidado
                </a>
            </div>
        </div>
    ...
    @foreach($cuidados as $cuidado)
        <tr>
            <td data-label="Nombre">
                <strong>{{ $cuidado->nombre }}</strong>
            </td>

            <td data-label="Descripción">
                {{ Str::limit($cuidado->descripcion, 80) }}
            </td>

            <td data-label="Acciones" class="pt-table-actions">
                <a href="{{ route('cuidados.edit', $cuidado) }}" class="pt-action-btn edit">
                    Editar
                </a>
