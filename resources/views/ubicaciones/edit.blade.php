...
<head>
    ...
    <style>
        /* ========== ESTILOS GLOBALES PLANTA TEC (versión compacta) ========== */
...
<body class="pt-app">
    ...
    <div class="pt-page">
        <div class="pt-container">
            ...
            <div class="pt-form-card">
                ...
                <form action="{{ route('ubicaciones.update', $ubicacion) }}" method="POST" id="formulario-ubicacion">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group full">
                            ...
                            <input type="text" name="nombre_lugar" id="nombre-lugar" value="{{ $ubicacion->nombre_lugar }}" required>
                        </div>

                        <div class="pt-form-group full">
                            <label>Descripción</label>
                            <textarea name="descripcion" id="descripcion" rows="4">{{ $ubicacion->descripcion }}</textarea>
                        </div>

                        <div class="pt-form-group">
                            <label>Latitud</label>
                            <input type="text" name="latitud" id="latitud" value="{{ $ubicacion->latitud }}" readonly>
                        </div>

                        <div class="pt-form-group">
                            <label>Longitud</label>
                            <input type="text" name="longitud" id="longitud" value="{{ $ubicacion->longitud }}" readonly>
                        </div>
                    </div>
    ...
    <script>
        // Datos de zonas recomendadas desde PHP
        ...
        // Coordenadas iniciales (de la ubicación actual, o coordenadas por defecto)
        const latInicial = {{ $ubicacion->latitud ?? 20.6597 }};
        const lngInicial = {{ $ubicacion->longitud ?? -103.3496 }};
        ...
        // Rellenar formulario desde zona recomendada
