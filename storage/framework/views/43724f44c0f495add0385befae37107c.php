     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="pt-header">
            ...
            <div class="pt-header-actions">
                <a href="<?php echo e(route('planta-cuidados.create')); ?>" class="pt-btn pt-btn-green">+ Asignar cuidado</a>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
                    ...
                    <table class="pt-admin-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $asignaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asignacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($asignacion->planta->nombre ?? 'Sin planta'); ?></td>
                                    <td><?php echo e($asignacion->cuidado->nombre ?? 'Sin cuidado'); ?></td>
                                    <td><?php echo e($asignacion->frecuencia); ?> días</td>
                                    <td><?php echo e(Str::limit($asignacion->instrucciones_esp, 60)); ?></td>
                                    <td class="pt-table-actions">
                                        <a href="<?php echo e(route('planta-cuidados.show', $asignacion)); ?>" class="pt-action-btn view">Ver</a>
                                        <a href="<?php echo e(route('planta-cuidados.edit', $asignacion)); ?>" class="pt-action-btn edit">Editar</a>
                                        <form action="<?php echo e(route('planta-cuidados.destroy', $asignacion)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/planta_cuidados/index.blade.php ENDPATH**/ ?>