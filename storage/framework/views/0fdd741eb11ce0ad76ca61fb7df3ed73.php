...
<head>
    ...
    <title>PlantaTec — Gestión de ubicaciones</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Estilos específicos para la tabla de administración de ubicaciones */
        .pt-admin-card {
            background: #ffffff;
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $ubicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubicacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="pt-table-actions">
                                        ...
                                        <a href="<?php echo e(route('ubicaciones.edit', $ubicacion)); ?>" class="pt-action-btn edit">Editar</a>
...
</html><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/ubicaciones/index.blade.php ENDPATH**/ ?>