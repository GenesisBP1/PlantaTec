     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="pt-header">
            <div>
                ...
                <h2 class="pt-header-title">Gestión de reportes</h2>
                    ...
                    <table class="pt-admin-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $reportes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($reporte->adopcion->usuario->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($reporte->adopcion->planta->nombre ?? 'N/A'); ?></td>
                                    <td><?php echo e($reporte->problema->nombre ?? 'N/A'); ?></td>
                                    <td><?php echo e(ucfirst($reporte->gravedad)); ?></td>
                                    <td><?php echo e(ucfirst(str_replace('_', ' ', $reporte->estado))); ?></td>
                                    <td><?php echo e($reporte->created_at->format('d/m/Y')); ?></td>
                                    <td class="pt-table-actions">
                                        <a href="<?php echo e(route('reporte-problemas.show', $reporte)); ?>" class="pt-action-btn view">Ver</a>
                                        <?php if(auth()->user()->rol === 'admin'): ?>
                                            <a href="<?php echo e(route('reporte-problemas.edit', $reporte)); ?>" class="pt-action-btn edit">Editar</a>
                                            <form action="<?php echo e(route('reporte-problemas.destroy', $reporte)); ?>" method="POST" style="display:inline;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="pt-action-btn delete" onclick="return confirm('¿Eliminar este reporte?')">Eliminar</button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="7" class="pt-empty center">No hay reportes de problemas registrados.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/reporte_problemas/index.blade.php ENDPATH**/ ?>