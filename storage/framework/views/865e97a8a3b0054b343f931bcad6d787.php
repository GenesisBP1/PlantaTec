    ...
    <div class="pt-page">
        <div class="pt-container pt-form-container">
            ...
            <div class="pt-form-card">
                ...
                <form action="<?php echo e(route('tratamientos.update', $tratamiento)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="pt-form-grid">
                        <div class="pt-form-group">
                            ...
                            <select name="id_problema" required>
                                ...
                                <?php $__currentLoopData = $problemas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $problema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($problema->id); ?>" <?php echo e(old('id_problema', $tratamiento->id_problema) == $problema->id ? 'selected' : ''); ?>>
                        ...
                        <div class="pt-form-group">
                            ...
                            <select name="id_planta">
                                <option value="" <?php echo e(old('id_planta', $tratamiento->id_planta) == null ? 'selected' : ''); ?>>
                                ...
                                <?php $__currentLoopData = $plantas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($planta->id); ?>" <?php echo e(old('id_planta', $tratamiento->id_planta) == $planta->id ? 'selected' : ''); ?>>
                        ...
                        <div class="pt-form-group">
                            ...
                            <div class="pt-input-inline">
                                <input type="number" name="frecuencia_dias" min="1" value="<?php echo e(old('frecuencia_dias', $tratamiento->frecuencia_dias ?? 1)); ?>" required>
                                <span>días</span>
                            </div>
                        </div>
                        ...
                        <div class="pt-form-group full">
                            ...
                            <textarea name="descripcion" rows="3"><?php echo e(old('descripcion', $tratamiento->descripcion)); ?></textarea>
                        </div>

                        <div class="pt-form-group full">
                            <label>Indicaciones</label>
                            <textarea name="indicaciones" rows="4"><?php echo e(old('indicaciones', $tratamiento->indicaciones)); ?></textarea>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/tratamientos/edit.blade.php ENDPATH**/ ?>