            ...
            <div class="plantas-list">
                <?php $__empty_1 = true; $__currentLoopData = $adopciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adopcion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="planta-card">
                        ...
                        <div class="info-planta">
                            ...
                            <div class="especie">
                                <?php echo e($planta->especie ?? 'Sin especie registrada'); ?>
                            ...
                            <div class="cuidados-list">
                                <?php $__empty_2 = true; $__currentLoopData = $cuidadosAsignados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                    <span class="cuidado-badge">
                                        <?php echo e($pc->cuidado->nombre ?? 'Cuidado'); ?> cada <?php echo e($pc->frecuencia); ?> días
                                    </span>
                            ...
                            <?php if($ultimoRegistro): ?>
                                <div class="ultima-evidencia">
                                    ...
                                    <span>
                                        Última evidencia: <?php echo e($ultimoRegistro->created_at->diffForHumans()); ?>
                        ...
                        <div class="acciones">
                            <a href="<?php echo e(route('adopciones.show', $adopcion)); ?>" class="btn-detalle">
                                <i class="fas fa-eye"></i> Ver detalle
                            </a>

                            <button class="btn-evidencia"
                                    data-adopcion-id="<?php echo e($adopcion->id); ?>"
                                    data-planta-nombre="<?php echo e($planta->nombre); ?>">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="bg-white rounded-2xl p-10 text-center text-gray-500">
                        ...
                        <a href="<?php echo e(route('catalogo.plantas')); ?>" class="text-green-600">
                            ¡Adopta una!
                        </a>
                    </div>
                <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\danie\Herd\PlantaTec\resources\views/adopciones/index_user.blade.php ENDPATH**/ ?>