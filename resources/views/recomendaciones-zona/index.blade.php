    ...
    <x-slot name="header">
        <div class="pt-header">
            ...
            <div class="pt-header-actions">
                <a href="{{ route('recomendaciones-zona.create') }}" class="pt-btn pt-btn-green">
                    + Nueva zona
                </a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pt-table-actions">
                                            <a href="{{ route('recomendaciones-zona.show', $zona) }}" class="pt-action-btn view">
                                                Ver
                                            </a>

                                            <a href="{{ route('recomendaciones-zona.edit', $zona) }}" class="pt-action-btn edit">
                                                Editar
                                            </a>
