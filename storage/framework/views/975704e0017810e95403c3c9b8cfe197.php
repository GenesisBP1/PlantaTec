...
<head>
    ...
    <title>PlantaTec — Editar cuidado</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ========== ESTILOS ESPECÍFICOS DEL FORMULARIO DE CUIDADOS ========== */
        .pt-form-container {
            max-width: 900px;
            margin: 0 auto;
        }
        ...
        <div class="pt-container pt-form-container">
            <div class="pt-form-card">
                <div class="pt-form-intro">
                    ...
                    <p class="pt-form-subtitle">Modifica la información del cuidado registrado.</p>
                </div>
                ...
                <form action="<?php echo e(route('cuidados.update', $cuidado)); ?>" method="POST">
                    ...
                    <div class="pt-form-grid">
                        <div class="pt-form-group full">
                            ...
                            <input type="text" name="nombre" value="<?php echo e(old('nombre', $cuidado->nombre)); ?>" required>
                        </div>
                    ...
                    <div class="pt-form-actions">
                        ...
                        <a href="<?php echo e(route('cuidados.index')); ?>" class="pt-btn pt-btn-dark">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/cuidados/edit.blade.php ENDPATH**/ ?>