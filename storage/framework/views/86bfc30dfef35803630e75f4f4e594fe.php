     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="pt-header">
            ...
            <div class="pt-header-actions">
                <a href="<?php echo e(route('dashboard')); ?>" class="pt-btn pt-btn-light">Volver al Dashboard</a>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
                ...
                <div class="pt-card-body">
                    <form method="GET" action="<?php echo e(route('admin.usuarios.index')); ?>">
                        <div style="flex: 2; min-width: 200px;">
                            ...
                            <input type="text" id="search" name="search" value="<?php echo e($search); ?>" class="pt-form-control" placeholder="Ej: Ana, ana@ejemplo.com">
                        </div>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td data-label="Usuario">
                                            ...
                                            <br><span class="pt-muted">ID: <?php echo e($usuario->id); ?></span>
                                        </td>
                                        <td data-label="Email"><?php echo e($usuario->email); ?></td>
                                        <td data-label="Adopciones"><?php echo e($usuario->total_adopciones); ?></td>
                                        <td data-label="Cuidados"><?php echo e($usuario->total_cuidados); ?></td>
                                        <td data-label="Problemas activos">
                                            <?php if($usuario->problemas_activos > 0): ?>
                                                <span class="pt-badge" style="background:#fee2e2; color:#b91c1c;"><?php echo e($usuario->problemas_activos); ?></span>
                                            <?php else: ?>
