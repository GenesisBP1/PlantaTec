    ...
    <x-slot name="header">
        <div class="pt-header">
            <div>
                ...
                <h2 class="pt-header-title">Hola, {{ Auth::user()->name }}</h2>
                <p class="pt-header-subtitle">{{ now()->isoFormat('dddd, D [de] MMMM [de] YYYY') }}</p>
            </div>
            <div class="pt-header-actions">
                <a href="{{ route('catalogo.plantas') }}" class="pt-btn pt-btn-green">Adoptar planta</a>
            </div>
        </div>
    </x-slot>
    ...
    <div class="pt-page">
        <div class="pt-container">
                ...
                <a href="{{ route('notificaciones.index') }}" class="pt-user-stat red">
                    <div class="pt-user-stat-content">
                        ...
                        <div class="pt-user-stat-icon">
                            ...
                            @if($misNotificaciones > 0)
                                <span class="pt-notification-badge">{{ $misNotificaciones > 9 ? '9+' : $misNotificaciones }}</span>
                            @endif
                        </div>
                    </div>
                    <p class="pt-user-stat-link red">
                        @if($misNotificaciones > 0) {{ $misNotificaciones }} sin leer @else Todo al día ✓ @endif
                    </p>
                </a>
            ...
            <div class="pt-user-actions-grid">
                ...
                <a href="{{ route('adopciones.index') }}" class="pt-user-action ">
                    <div class="pt-user-action-icon">
                ...
                <a href="{{ route('notificaciones.index') }}" class="pt-user-action ">
                    <div class="pt-user-action-icon">
                        <img src="https://images.icon-icons.com/1863/PNG/512/notifications_118871.png" alt="Notificaciones">
                        @if($misNotificaciones > 0)
                            <span class="pt-action-badge">{{ $misNotificaciones > 9 ? '9+' : $misNotificaciones }}</span>
                        @endif
                    </div>
                    <div class="pt-user-action-text">
                        <p class="pt-user-action-title">Notificaciones</p>
                        <p class="pt-user-action-subtitle">
                            @if($misNotificaciones > 0) Tienes {{ $misNotificaciones }} sin leer @else Todo al día @endif
                        </p>
                    </div>
                    <span class="pt-user-arrow">›</span>
                </a>
                <a href="{{ route('registro-cuidados.index') }}" class="pt-user-action pink">
                    <div class="pt-user-action-icon">
                ...
                <div class="pt-user-banner active">
                    ...
                    <div class="pt-user-banner-content">
                        <div>
                            ...
                            <p class="pt-banner-title">Tienes {{ $misNotificaciones }} {{ $misNotificaciones === 1 ? 'recomendación pendiente' : 'recomendaciones pendientes' }}</p>
                            <p class="pt-banner-text">Revisa los cuidados sugeridos.</p>
                        </div>
                        <a href="{{ route('notificaciones.index') }}" class="pt-banner-btn">Revisar ahora</a>
                    </div>
                </div>
            @else
            ...
            @if(isset($ultimasPlantas) && $ultimasPlantas->count() > 0)
                <div class="pt-card">
                    <div class="pt-card-header">
                        ...
                        <a href="{{ route('adopciones.index') }}" class="pt-link green">Ver todas →</a>
                    </div>
                    <div class="pt-last-plants-grid">
                        @foreach($ultimasPlantas as $adopcion)
                            <div class="pt-last-plant-card">
                                <img src="{{ $adopcion->planta->imagen ?? 'https://images.unsplash.com/photo-1592150621744-aca64f48394a?w=400&h=200&fit=crop' }}" alt="{{ $adopcion->planta->nombre ?? 'Planta' }}">
                                <div class="pt-last-plant-body">
                                    ...
                                    <div class="pt-last-plant-footer">
                                        <span class="pt-badge green">{{ $adopcion->planta->tipo_zona ?? 'Interior' }}</span>
                                        <a href="{{ route('catalogo.plantas.show', $adopcion->planta->id) }}" class="pt-link green">Ver →</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
