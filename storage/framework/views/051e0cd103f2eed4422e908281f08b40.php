...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center text-sm text-gray-500 pt-1">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-green-600 hover:text-green-700 font-semibold hover:underline transition">
                Regístrate gratis
            </a>
        </p>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/auth/login.blade.php ENDPATH**/ ?>