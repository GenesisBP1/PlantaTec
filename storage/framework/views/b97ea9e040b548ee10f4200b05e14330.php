    ...
    <div class="pt-page">
        <div class="pt-container pt-form-container">
            ...
            <div class="pt-form-card">
                ...
                <form action="<?php echo e(route('problemas.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group full">
                            ...
                            <input type="text" name="imagen" value="<?php echo e(old('imagen')); ?>" placeholder="URL o referencia">
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/problemas/create.blade.php ENDPATH**/ ?>