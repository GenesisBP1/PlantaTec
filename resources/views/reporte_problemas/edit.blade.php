        ...
        <div class="pt-container pt-form-container">
            <div class="pt-form-card">
                <div class="pt-form-intro">
                    ...
                    <h3 class="pt-form-title">{{ $reporteProblema->adopcion->planta->nombre ?? 'Planta no disponible' }}</h3>
                    <p class="pt-form-subtitle">Modifica el diagnóstico, gravedad o estado del reporte.</p>
                </div>
                ...
                <form action="{{ route('reporte-problemas.update', $reporteProblema) }}" method="POST">
                        ...
                        <div class="pt-form-group full">
                            ...
                            <select name="id_problema" required>
                                @foreach($problemas as $problema)
                                    <option value="{{ $problema->id }}" {{ old('id_problema', $reporteProblema->id_problema) == $problema->id ? 'selected' : '' }}>
                                        {{ $problema->nombre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="pt-form-actions">
                        ...
                        <a href="{{ route('reporte-problemas.index') }}" class="pt-btn pt-btn-dark">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
