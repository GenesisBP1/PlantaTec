...
<head>
    ...
    {{-- CSS GLOBAL EMBEBIDO (el mismo bloque que proporcionaste) --}}
    <style>
        /* ========== ESTILOS GLOBALES PLANTA TEC ========== */
        /* (Aquí va TODO el CSS que me diste al final, desde .pt-page hasta el final) */
        /* Por brevedad en esta respuesta no lo repito, pero en el archivo final se debe copiar completo. */
        /* En el entregable final sí lo incluiré. */
    ...
    <style>
        /* Estilos adicionales específicos para guest (los que ya tenía) */
