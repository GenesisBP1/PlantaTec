...
<head>
    ...
    <title>PlantaTec — Detalle de planta</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Estilos específicos para el detalle de planta */
        .pt-form-container {
            max-width: 900px;
            margin: 0 auto;
        }
        ...
        <div class="pt-container pt-form-container">
            ...
            <div class="pt-form-card">
                ...
                <div class="pt-form-actions">
                    <a href="{{ route('plantas.edit', $planta) }}" class="pt-btn pt-btn-yellow">Editar</a>
                    <a href="{{ route('plantas.index') }}" class="pt-btn pt-btn-dark">Volver</a>
                </div>
