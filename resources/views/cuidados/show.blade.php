...
<head>
    ...
    <title>PlantaTec — Detalle del cuidado</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ========== ESTILOS ESPECÍFICOS DE DETALLE DE CUIDADO ========== */
        .pt-form-container {
            max-width: 900px;
            margin: 0 auto;
        }
        ...
        <div class="pt-container pt-form-container">
            <div class="pt-form-card">
                <div class="pt-form-intro">
                    ...
                    <p class="pt-form-subtitle">Información completa del cuidado registrado.</p>
                </div>
                ...
                <div class="pt-form-actions">
                    <a href="{{ route('cuidados.edit', $cuidado) }}" class="pt-btn pt-btn-yellow">Editar</a>
                    <a href="{{ route('cuidados.index') }}" class="pt-btn pt-btn-dark">Volver</a>
                </div>
            </div>
        </div>
    </div>
