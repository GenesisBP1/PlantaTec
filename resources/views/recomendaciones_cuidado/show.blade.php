        ...
        <div class="pt-container pt-form-container">
            ...
            <div class="pt-form-card">
                ...
                <div class="pt-form-actions">
                    <a href="{{ route('recomendaciones-cuidado.edit', $recomendacion->id) }}" class="pt-btn pt-btn-yellow">Editar</a>
                    <a href="{{ route('recomendaciones-cuidado.index') }}" class="pt-btn pt-btn-dark">Volver</a>
                </div>
