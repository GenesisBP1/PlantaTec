...
<head>
    ...
    <title>PlantaTec — Registrar planta</title>
    ...
    <style>
        ...
        /* (Se incluye el bloque completo proporcionado por el usuario) */
            ...
            <div class="pt-form-card">
                ...
                <form action="{{ route('plantas.store') }}" method="POST">
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group">
                            <label>Imagen</label>
                            <input type="text" name="imagen" placeholder="URL o nombre de imagen">
                        </div>
