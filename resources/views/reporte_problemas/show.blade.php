...
<head>
    ...
    <title>PlantaTec — Diagnóstico del problema</title>
    ...
    <style>
        /* ========== ESTILOS GLOBALES PLANTA TEC (proporcionados por el usuario, completos) ========== */
        /* Se incluye el bloque completo, sin cambios, para mantener la coherencia visual */
        ...
        * {
        ...
        /* Estilos específicos para el diagnóstico y tratamiento */
        .pt-form-card {
            background: #ffffff;
        ...
        <div class="pt-container">
            ...
            <div class="pt-form-card">
                <div class="pt-form-intro">
                    ...
                    <h3 class="pt-form-title">{{ $reporteProblema->problema->nombre ?? 'Problema no disponible' }}</h3>
                    <p class="pt-form-subtitle">Gravedad: {{ ucfirst($reporteProblema->gravedad ?? 'leve') }} · Estado: {{ ucfirst(str_replace('_', ' ', $reporteProblema->estado ?? 'pendiente')) }}</p>
                </div>

                <div class="pt-detail-grid">
                    <div class="pt-detail-item full">
                        <strong>Descripción</strong>
                        <span>{{ $reporteProblema->descripcion ?? 'Sin descripción adicional.' }}</span>
                    </div>
                    @if($reporteProblema->imagen)
                        <div class="pt-detail-item full">
                            <strong>Evidencia del problema</strong>
                            <img src="{{ asset('storage/' . $reporteProblema->imagen) }}" class="pt-problem-image" alt="Evidencia del problema">
                        </div>
                    @endif
                </div>
            </div>

            <!-- Tratamiento sugerido (si existe) -->
            @php
            ...
            @if($tratamiento)
                <div class="pt-form-card">
                    <div class="pt-form-intro">
                        ...
                        <h3 class="pt-form-title">Aplicar tratamiento</h3>
                        <p class="pt-form-subtitle">Registra la aplicación del tratamiento recomendado.</p>
                    </div>
                    ...
                    <form action="{{ route('reporte-problemas.aplicar-tratamiento', $reporteProblema) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="pt-form-grid">
                            <div class="pt-form-group full">
                                ...
                                <input type="datetime-local" name="fecha_aplicacion" value="{{ now()->format('Y-m-d\TH:i') }}" required>
                            </div>
                            <div class="pt-form-group full">
                        ...
                        <div class="pt-form-actions">
                            <button type="submit" class="pt-btn pt-btn-green">Registrar aplicación</button>
                        </div>
                    </form>
                </div>
            @else
            ...
            <div class="pt-form-actions" style="justify-content: flex-start;">
                <a href="{{ route('reporte-problemas.index') }}" class="pt-btn pt-btn-dark">Volver</a>
            </div>
