...
<?php $component->withAttributes([]); ?>
    ...
    <style>
        ...
        /* (Aquí va TODO el CSS que me proporcionaste al final del mensaje, desde .pt-page hasta el final) */
        .pt-page {
            padding: 3.5rem 0;
        }
        .pt-container {
        ...
        * {
        ...
        .pt-welcome-hero {
            ...
            background: radial-gradient(ellipse 70% 60% at 80% 30%, rgba(187,247,208,0.45) 0%, transparent 65%), radial-gradient(ellipse 50% 40% at 10% 80%, rgba(220,252,231,0.35) 0%, transparent 55%), #fafaf9;
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
...
<?php endif; ?><?php /**PATH C:\Users\1\Herd\plantatec\resources\views/notificaciones/index.blade.php ENDPATH**/ ?>