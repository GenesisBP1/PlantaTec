    ...
    <x-slot name="header">
        <div class="pt-header">
            ...
            <div class="pt-header-actions">
                <a href="{{ route('recomendaciones-cuidado.create') }}" class="pt-btn pt-btn-green">+ Registrar recomendación</a>
            </div>
        </div>
    </x-slot>
                    ...
                    <table class="pt-admin-table">
                        ...
                        <tbody>
                            @forelse($recomendaciones as $recomendacion)
                                <tr>
                                    <td>{{ $recomendacion->adopcion->planta->nombre ?? 'N/A' }}</td>
                                    <td>{{ $recomendacion->plantaCuidado->cuidado->nombre ?? 'N/A' }}</td>
                                    <td>{{ Str::limit($recomendacion->mensaje, 60) }}</td>
                                    <td>{{ ucfirst($recomendacion->prioridad) }}</td>
                                    <td>{{ ucfirst($recomendacion->estado) }}</td>
                                    <td class="pt-table-actions">
                                        <a href="{{ route('recomendaciones-cuidado.show', $recomendacion->id) }}" class="pt-action-btn view">Ver</a>
                                        <a href="{{ route('recomendaciones-cuidado.edit', $recomendacion->id) }}" class="pt-action-btn edit">Editar</a>
                                        <form action="{{ route('recomendaciones-cuidado.destroy', $recomendacion->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
