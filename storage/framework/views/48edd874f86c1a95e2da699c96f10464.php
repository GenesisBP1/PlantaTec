    ...
    <nav x-data="{ open: false }" class="pt-navbar">
        ...
        <div x-show="open" x-transition class="pt-mobile-menu" style="display:none;">
            ...
            <?php else: ?>
                ...
                <?php $notificacionesNoLeidasMovil = \App\Models\Notificacion::where('id_usuario', auth()->id())->where('leida', false)->count(); ?>
                <a href="<?php echo e(route('notificaciones.index')); ?>">Notificaciones <?php if($notificacionesNoLeidasMovil > 0): ?><span class="pt-nav-badge"><?php echo e($notificacionesNoLeidasMovil > 9 ? '9+' : $notificacionesNoLeidasMovil); ?></span><?php endif; ?></a>
            <?php endif; ?>
        ...
        <div class="pt-container">
            <div class="pt-header">
                ...
                <div class="pt-header-actions">
                    <a href="<?php echo e(route('cuidados.create')); ?>" class="pt-btn pt-btn-green">Registrar Cuidado</a>
                </div>
            </div>
            ...
            <div class="pt-card">
                ...
                <div class="pt-card-body">
                    <?php if($tableCuidadosRows->count() > 0): ?>
                        <div class="pt-table-wrapper">
                            <table class="pt-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $tableCuidadosRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuidado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td data-label="Nombre"><strong><?php echo e($cuidado->nombre); ?></strong></td>
                                            <td data-label="Descripción"><?php echo e(Str::limit($cuidado->descripcion, 60)); ?></td>
                                            <td data-label="Acciones" class="pt-table-actions">
                                                <a href="<?php echo e(route('cuidados.edit', $cuidado)); ?>" class="pt-action-btn edit">Editar</a>
                                                <form action="<?php echo e(route('cuidados.destroy', $cuidado)); ?>" method="POST" style="display: inline-block;">
                                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/cuidados/index.blade.php ENDPATH**/ ?>