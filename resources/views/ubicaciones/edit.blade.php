                ...
                <form action="{{ route('ubicaciones.update', $ubicacion) }}" method="POST" id="formulario-ubicacion">
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group full">
                            ...
                            <input type="text" name="nombre_lugar" id="nombre-lugar" value="{{ old('nombre_lugar', $ubicacion->nombre_lugar) }}" required>
                        </div>

                        <div class="pt-form-group full">
                            <label>Descripción</label>
                            <textarea name="descripcion" id="descripcion" rows="4">{{ old('descripcion', $ubicacion->descripcion) }}</textarea>
                        </div>

                        <div class="pt-form-group">
                            <label>Latitud</label>
                            <input type="text" name="latitud" id="latitud" value="{{ old('latitud', $ubicacion->latitud) }}" readonly>
                        </div>

                        <div class="pt-form-group">
                            <label>Longitud</label>
                            <input type="text" name="longitud" id="longitud" value="{{ old('longitud', $ubicacion->longitud) }}" readonly>
                        </div>
                    </div>
