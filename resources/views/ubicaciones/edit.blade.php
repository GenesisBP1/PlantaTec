<x-app-layout>
   ...
   <style>
    ...
    <script>
        // (Mismo script que en create, adaptado con valores iniciales)
        ...
        window.addEventListener('load', function() {
            const latActual = {{ $ubicacion->latitud ?? 25.5095 }};
            const lngActual = {{ $ubicacion->longitud ?? -97.1559 }};
            if (window.mapaInstancias && window.mapaInstancias['mapa-ubicacion']) {
                window.mapaInstancias['mapa-ubicacion'].setView([latActual, lngActual], 15);
            }
        });
