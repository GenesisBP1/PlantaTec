                            ...
                            <select name="id_problema" required>
                                ...
                                <?php $__currentLoopData = $problemas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $problema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($problema->id); ?>"
                                        <?php echo e(old('id_problema', $tratamiento->id_problema) == $problema->id ? 'selected' : ''); ?>>
                            ...
                            <select name="id_planta">
                                ...
                                <?php $__currentLoopData = $plantas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($planta->id); ?>"
                                        <?php echo e(old('id_planta', $tratamiento->id_planta) == $planta->id ? 'selected' : ''); ?>>
                        ...
                        <div class="pt-form-group">
                            ...
                            <div class="pt-input-inline">
                                <input type="number"
                                       ...
                                       min="1"
                                       value="<?php echo e(old('frecuencia_dias', $tratamiento->frecuencia_dias ?? 1)); ?>"
                                       required>
...
<?php endif; ?><?php /**PATH C:\Users\danie\Herd\PlantaTec\resources\views/tratamientos/edit.blade.php ENDPATH**/ ?>