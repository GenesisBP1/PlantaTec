<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-widest text-green-600 mb-0.5">Mi espacio verde</p>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="{{ route('adopciones.index') }}"
                   class="group relative bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-green-200 transition overflow-hidden">
                ...
                <a href="{{ route('notificaciones.index') }}"
                   class="group relative bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-red-200 transition overflow-hidden">
                ...
                {{-- Recomendaciones --}}
                <a href="{{ route('notificaciones.index') }}"
                   class="group relative bg-white border border-gray-100 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-amber-200 transition overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {{-- Catálogo --}}
                <a href="{{ route('catalogo.plantas') }}"
                   class="group flex items-center gap-4 bg-white border border-gray-100 hover:border-green-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition">
                ...
                {{-- Mis adopciones --}}
                <a href="{{ route('adopciones.index') }}"
                   class="group flex items-center gap-4 bg-white border border-gray-100 hover:border-blue-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition">
                ...
                {{-- Notificaciones --}}
                <a href="{{ route('notificaciones.index') }}"
                   class="group flex items-center gap-4 bg-white border border-gray-100 hover:border-red-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition">
            ...
            {{-- ════════════════════════════
                 BANNER MOTIVACIONAL / PRÓXIMOS CUIDADOS
                 (opcional — conectar con datos reales)
            ════════════════════════════ --}}
            @if($misNotificaciones > 0)
            <div class="relative bg-gradient-to-r from-green-600 to-emerald-500 rounded-2xl p-6 text-white overflow-hidden shadow-md">
                ...
                <div class="relative flex items-center justify-between gap-4">
                    ...
                    <a href="{{ route('notificaciones.index') }}"
                       class="shrink-0 bg-white text-green-700 hover:bg-green-50 font-semibold text-sm px-4 py-2.5 rounded-xl transition shadow-sm">
                        Revisar ahora
                    </a>
                </div>
            </div>
