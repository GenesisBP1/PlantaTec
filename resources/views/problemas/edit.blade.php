                ...
                <form action="{{ route('problemas.update', $problema) }}" method="POST">
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group full">
                            <label>Nombre</label>
                            <input type="text" name="nombre" value="{{ old('nombre', $problema->nombre) }}" required>
                        </div>
                        ...
                        <div class="pt-form-group full">
                            ...
                            <input type="text" name="imagen" value="{{ old('imagen', $problema->imagen) }}" placeholder="URL o referencia">
                        </div>
