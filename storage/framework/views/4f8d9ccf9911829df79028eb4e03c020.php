...
<head>
    ...
    <title>PlantaTec — Registrar ubicación</title>
    ...
    <div class="pt-page">
        <div class="pt-container">
            <div class="pt-form-card">
                ...
                <form action="<?php echo e(route('ubicaciones.store')); ?>" method="POST" id="formulario-ubicacion">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group full">
                            ...
                            <div id="mapa-ubicacion" class="mapa-container"></div>
                            <div class="mapa-toolbar">
                                <button type="button" id="geolocalizar-btn" class="mapa-btn blue">📍 Usar mi ubicación</button>
                            </div>
                        </div>
...
</html><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/ubicaciones/create.blade.php ENDPATH**/ ?>