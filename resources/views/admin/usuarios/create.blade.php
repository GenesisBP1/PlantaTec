...
<head>
    ...
    <title>PlantaTec — Crear nuevo usuario</title>
    ...
    <style>
        ...
        /* (Mismo bloque que en las páginas anteriores, completo) */
        ...
        * { box-sizing: border-box; }
        ...
        .pt-admin-header-title {
            font-size: 1.8rem;
            font-weight: 800;
            color: #111827;
            line-height: 1.2;
        }
        .pt-admin-header-subtitle {
            font-size: 0.875rem;
            color: #6b7280;
            margin-top: 0.25rem;
        }
        ...
        .pt-input-icon input, .pt-input-icon select {
            width: 100%;
        ...
        .pt-input-icon input:focus, .pt-input-icon select:focus {
            outline: none;
            border-color: #16a34a;
...
<body class="pt-app">
    ...
    <div class="pt-container" style="padding: 2rem 1.5rem;">
        <div class="pt-admin-header">
            <div class="pt-admin-header-label">Administración</div>
            <div class="pt-header" style="justify-content: space-between;">
                <h1 class="pt-admin-header-title">Crear nuevo usuario</h1>
                <a href="{{ route('admin.usuarios.index') }}" class="pt-btn pt-btn-light">
                    ← Volver
                </a>
            </div>
            <p class="pt-admin-header-subtitle">Registra un nuevo usuario en el sistema</p>
        </div>
        ...
        <div class="pt-card">
            <form method="POST" action="{{ route('admin.usuarios.store') }}">
                ...
                <div class="pt-form-group">
                    <label><span class="text-red-500">*</span> Nombre completo</label>
                    ...
                    @error('name')
                        <p class="pt-error-text">{{ $message }}</p>
                    @enderror
                </div>

                <div class="pt-form-group">
                    <label><span class="text-red-500">*</span> Correo electrónico</label>
                    <div class="pt-input-icon">
                        <div class="pt-icon">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="18" height="18">
                ...
                <div class="pt-form-group">
                    <label><span class="text-red-500">*</span> Rol</label>
                    <div class="pt-input-icon">
                        <div class="pt-icon">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="18" height="18">
                ...
                <div class="pt-form-group">
                    <label><span class="text-red-500">*</span> Contraseña</label>
                    <div class="pt-input-icon">
                        <div class="pt-icon">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="18" height="18">
                ...
                <div class="pt-form-group">
                    <label><span class="text-red-500">*</span> Confirmar contraseña</label>
                    <div class="pt-input-icon">
                        <div class="pt-icon">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="18" height="18">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                ...
                <div class="pt-form-actions">
                    <a href="{{ route('admin.usuarios.index') }}" class="pt-btn pt-btn-gray">Cancelar</a>
                    <button type="submit" class="pt-btn pt-btn-green">Crear usuario</button>
                </div>
            </form>
        </div>
    </div>
