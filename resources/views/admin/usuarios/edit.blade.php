...
<head>
    ...
    <title>PlantaTec — Editar usuario</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .pt-input-icon input:focus, 
        .pt-input-icon select:focus {
            outline: none;
            border-color: #16a34a;
        ...
        @media (max-width: 768px) {
            ...
            .pt-form-actions a, .pt-form-actions button {
                width: 100%;
        ...
        <div class="pt-container pt-form-container">
            ...
            <div class="pt-header">
                <div>
                    ...
                    <h2 class="pt-header-title">Editar usuario: {{ $usuario->name }}</h2>
                    <p class="pt-header-subtitle">Modifica los datos del usuario</p>
                </div>
            ...
            <div class="pt-form-card">
                <form method="POST" action="{{ route('admin.usuarios.update', $usuario->id) }}">
                    ...
                    <div class="pt-form-actions">
                        ...
                        <button type="submit" class="pt-btn pt-btn-green pt-btn-gradient">
