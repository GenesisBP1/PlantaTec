...
<head>
    ...
    <title>PlantaTec — Detalle de ubicación</title>
    ...
    <style>
        ...
        .pt-form-container { max-width: 900px; margin: 0 auto; }
        ...
        @media (max-width: 768px) { .pt-detail-grid { grid-template-columns: 1fr; } .pt-form-card { padding: 1.25rem; } .pt-form-title { font-size: 1.6rem; } }
        ...
        <div class="pt-container pt-form-container">
            <div class="pt-form-card">
                <div class="pt-form-intro">
                    ...
                    <h3 class="pt-form-title"><?php echo e($ubicacion->nombre_lugar); ?></h3>
                ...
                <div class="pt-detail-grid">
                    <div class="pt-detail-item">
                        <strong>Tipo</strong>
                        <span><?php echo e(ucfirst($ubicacion->tipo)); ?></span>
                    </div>
                    <div class="pt-detail-item">
                        <strong>Latitud</strong>
                        <span><?php echo e($ubicacion->latitud ?? 'No especificada'); ?></span>
                    </div>
                    <div class="pt-detail-item">
                        <strong>Longitud</strong>
                        <span><?php echo e($ubicacion->longitud ?? 'No especificada'); ?></span>
                    </div>
                    <div class="pt-detail-item full">
                        <strong>Descripción</strong>
                        <span><?php echo e($ubicacion->descripcion ?? 'Sin descripción.'); ?></span>
                    </div>
                </div>

                <div class="pt-form-actions">
                    <a href="<?php echo e(route('ubicaciones.edit', $ubicacion)); ?>" class="pt-btn pt-btn-yellow">Editar</a>
                    <a href="<?php echo e(route('ubicaciones.index')); ?>" class="pt-btn pt-btn-dark">Volver</a>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/ubicaciones/show.blade.php ENDPATH**/ ?>