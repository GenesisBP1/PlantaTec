...
<head>
    ...
    <title>PlantaTec — Editar asignación de cuidado</title>
                ...
                <form action="{{ route('planta-cuidados.update', $asignacion) }}" method="POST">
                    ...
                    <div class="pt-form-grid">
                        ...
                        <div class="pt-form-group">
                            ...
                            <select name="id_planta" required>
                                ...
                                @foreach($plantas as $planta)
                                    <option value="{{ $planta->id }}" {{ old('id_planta', $asignacion->id_planta) == $planta->id ? 'selected' : '' }}>
                                        {{ $planta->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="pt-form-group">
                            ...
                            <select name="id_cuidado" required>
                                ...
                                @foreach($cuidados as $cuidado)
                                    <option value="{{ $cuidado->id }}" {{ old('id_cuidado', $asignacion->id_cuidado) == $cuidado->id ? 'selected' : '' }}>
                                        {{ $cuidado->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="pt-form-group full">
                            ...
                            <input type="number" name="frecuencia" min="1" value="{{ old('frecuencia', $asignacion->frecuencia) }}" required>
                        </div>
                        ...
                        <div class="pt-form-group full">
                            ...
                            <input type="text" name="evidencia" value="{{ old('evidencia', $asignacion->evidencia) }}">
                        </div>
