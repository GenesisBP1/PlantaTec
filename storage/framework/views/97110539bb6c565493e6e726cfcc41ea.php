                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <?php if($pc->instrucciones_esp): ?>
                                                <br><small class="text-gray-500"><?php echo e(Str::limit($pc->instrucciones_esp, 80)); ?></small>
                                            <?php endif; ?>
                                        </td>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $adopcion->reportesProblemas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border-b border-gray-100 py-4">
                            <div class="flex flex-wrap justify-between items-start gap-2">
                                <div>
                                    <strong class="text-gray-800"><?php echo e($reporte->problema->nombre); ?></strong>
                                    <span class="badge-estado
                                        <?php if($reporte->estado === 'activo'): ?> badge-activo
                                        <?php elseif($reporte->estado === 'en_revision'): ?> badge-revision
                                        <?php else: ?> badge-resuelto <?php endif; ?> ml-2">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $reporte->estado))); ?>

                                    </span>
                                </div>
                                <span class="text-xs text-gray-500">Gravedad: <?php echo e(ucfirst($reporte->gravedad)); ?></span>
                            </div>
                            <p class="text-gray-600 text-sm mt-1"><?php echo e($reporte->descripcion ?? 'Sin descripción'); ?></p>
                            <div class="mt-3">
                                <a href="<?php echo e(route('reporte-problemas.show', $reporte)); ?>" class="text-green-700 text-sm font-medium hover:underline">
                                    Ver diagnóstico
                                </a>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\1\Herd\plantatec\resources\views/adopciones/show.blade.php ENDPATH**/ ?>