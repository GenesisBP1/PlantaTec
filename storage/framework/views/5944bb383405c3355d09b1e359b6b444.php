     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="pt-header">
            <div>
                ...
                <h2 class="pt-header-title">Gestión de recomendaciones de cuidado</h2>
                <p class="pt-header-subtitle">Panel de administración</p>
            </div>
            <div class="pt-header-actions">
                <a href="<?php echo e(route('recomendaciones-cuidado.create')); ?>" class="pt-btn pt-btn-green">+ Registrar recomendación</a>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
                    ...
                    <table class="pt-admin-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recomendaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recomendacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($recomendacion->adopcion->planta->nombre ?? 'N/A'); ?></td>
                                    <td><?php echo e($recomendacion->plantaCuidado->cuidado->nombre ?? 'N/A'); ?></td>
                                    <td><?php echo e(Str::limit($recomendacion->mensaje, 60)); ?></td>
                                    <td><?php echo e(ucfirst($recomendacion->prioridad)); ?></td>
                                    <td><?php echo e(ucfirst($recomendacion->estado)); ?></td>
                                    <td class="pt-table-actions">
                                        <a href="<?php echo e(route('recomendaciones-cuidado.show', $recomendacion->id)); ?>" class="pt-action-btn view">Ver</a>
                                        <a href="<?php echo e(route('recomendaciones-cuidado.edit', $recomendacion->id)); ?>" class="pt-action-btn edit">Editar</a>
                                        <form action="<?php echo e(route('recomendaciones-cuidado.destroy', $recomendacion->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" class="pt-action-btn delete" onclick="return confirm('¿Eliminar esta recomendación?')">Eliminar</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="6" class="pt-empty center">No hay recomendaciones registradas.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                <?php echo e($recomendaciones->links()); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\8\Prog de backend\Laravel Herd\PlantaTec\resources\views/recomendaciones_cuidado/index.blade.php ENDPATH**/ ?>