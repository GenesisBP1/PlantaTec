        ...
        <div class="pt-container">
            ...
            <div class="pt-card">
                <div class="pt-card-body">
                    <form method="GET" action="{{ route('admin.usuarios.index') }}" style="display: flex; gap: 1rem; align-items: flex-end;">
                        <div style="flex:1">
                            <label>Buscar usuario por nombre o email</label>
                            <input type="text" name="search" value="{{ $search }}" class="pt-form-control" placeholder="Ej: Juan, juan@email.com">
                        </div>
                        <div>
                                ...
                                @forelse($usuarios as $usuario)
                                    <tr>
                                        <td>
                                            ...
                                            <span class="pt-muted">ID: {{ $usuario->id }}</span>
                                        </td>
                                        <td>{{ $usuario->email }}</td>
                                        <td>{{ $usuario->total_adopciones }}</td>
                                        <td>{{ $usuario->total_cuidados }}</td>
                                        <td>{{ $usuario->problemas_activos }}</td>
                                        <td>
