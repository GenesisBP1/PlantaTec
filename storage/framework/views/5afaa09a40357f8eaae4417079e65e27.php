                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $adopcion->registrosCuidados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="pt-history-item">
                            ...
                            <?php if($registro->imagen): ?>
                                <img src="<?php echo e(asset('storage/' . $registro->imagen)); ?>" class="pt-history-image" alt="Evidencia de cuidado">
                            <?php endif; ?>
                        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $adopcion->reportesProblemas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="pt-problem-item">
                            <div class="pt-problem-header">
                                ...
                                <span class="pt-muted">Gravedad: <?php echo e(ucfirst($reporte->gravedad)); ?></span>
                            </div>

                            <p class="pt-history-text"><?php echo e($reporte->descripcion ?? 'Sin descripción'); ?></p>

                            <a href="<?php echo e(route('reporte-problemas.show', $reporte)); ?>" class="pt-link green">
                                Ver diagnóstico
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <table class="pt-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $tratamientosReporte; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tratamientoReporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <strong><?php echo e($tratamientoReporte->reporte_original->problema->nombre ?? 'Problema no disponible'); ?></strong>
                                                <br>
                                                <small>Gravedad: <?php echo e(ucfirst($tratamientoReporte->reporte_original->gravedad ?? 'Sin gravedad')); ?></small>
                                            </td>

                                            <td>
                                                <strong><?php echo e($tratamientoReporte->tratamiento->descripcion ?? 'Tratamiento sin descripción'); ?></strong>
                                                <?php if($tratamientoReporte->descripcion): ?>
                                                    <br>
                                                    <small>Último registro: <?php echo e($tratamientoReporte->descripcion); ?></small>
                                                <?php endif; ?>
                                            </td>

                                            <td>Cada <?php echo e($tratamientoReporte->frecuencia_dias ?? 1); ?> días</td>
                                            ...
                                            <td>
                                                <?php if($tratamientoReporte->imagen): ?>
                                                    <img src="<?php echo e(asset('storage/' . $tratamientoReporte->imagen)); ?>" class="pt-table-image" alt="Evidencia del tratamiento">
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('reporte-problemas.show', $tratamientoReporte->reporte_original->id)); ?>" class="pt-small-btn green">
                                                    Ver diagnóstico
                                                </a>
                                            </td>
                                        </tr>
