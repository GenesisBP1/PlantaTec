                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $plantas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-t">
                                <td class="p-3"><?php echo e($planta->nombre); ?></td>
                                <td class="p-3"><?php echo e($planta->especie); ?></td>
                                <td class="p-3"><?php echo e($planta->tipo_zona); ?></td>
                                <td class="p-3"><?php echo e($planta->estado); ?></td>
                                <td class="p-3 flex gap-2">
                                    <a href="<?php echo e(route('plantas.show', $planta)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\1\Herd\plantatec\resources\views/plantas/index.blade.php ENDPATH**/ ?>